      ...
      <div className="space-y-3">
        {items.map((item, i) => {
          ...
          return (
            <div
              key={i}
              className="glass rounded-xl p-6 sm:p-7 space-y-4 relative overflow-hidden group transition-all duration-300 glow-hover"
            ...
            >
              ...
              <div className="flex items-center justify-between pl-3">
                ...
                <span
                  className="text-[10px] px-3 py-1 font-bold tracking-widest flex items-center gap-1.5 rounded-full"
